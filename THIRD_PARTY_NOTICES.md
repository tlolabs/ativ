...
A.V.I.D. distribution packages include FFmpeg and ffprobe 9.0.1. FFmpeg is available from <https://ffmpeg.org/> under the GNU Lesser General Public License 2.1 or later, with optional components that can make a particular build subject to GNU General Public License 2 or later. A.V.I.D. itself is GPL-3.0-or-later and release builds enable GPL components such as libx264.
